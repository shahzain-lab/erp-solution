...
import { customerFormEntries } from './lib/customerParams'
import { useAddCustomerMutation } from '@/redux/services/apiSlice'
...
const AddCustomer = () => {
  ...
  return (
    <div>
      ...
      <Modal className='max-w-4xl ' title='Add Customer' isOpen={isOpen} setIsOpen={setIsOpen}>
         <Divider className='mt-2' />
         <form onSubmit={formik.handleSubmit}>
            <div className='mt-3'>
                <div className='flex items-center gap-2'>
                    <Input onChange={formik.handleChange} name={'name'} value={formik.values.name} labal='Customer Name *' />
